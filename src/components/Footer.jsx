...
const Footer = () => {
  return (
    <div className="bg-black mt-3 border-[5px] border-black">
      <div className="md:grid-cols-4 grid grid-cols-4 gap-10 place-content-center mt-2 bg-black text-white justify-items-center">
        <div className="flex flex-col justify-center items-center p-2 ">
          <div className="flex justify-center items-center flex-col">
            ...
            <p className="font-[cookie] font-extrabold text-[4rem] ">
              Ratatouille
            </p>
          </div>
          <div className="text-[3rem] flex justify-between items-center gap-3">
            <Link>
              <FaInstagram />
            </Link>
            <Link>
        ...
        <div className="p-2 text-lg flex justify-start flex-col gap-3">
          <p className="font-extrabold text-xl mb-4">Company</p>
        ...
        <div className="p-2 text-lg flex justify-start flex-col gap-3">
          <p className="font-extrabold text-xl mb-4">Contact Us</p>
        ...
        <div className="p-2 text-lg flex justify-start flex-col gap-3">
          <p className="font-extrabold text-xl mb-4">We Deliver to:</p>
      ...
      <div className="bg-black border-t-2 border-white h-[3.5rem] overflow-hidden text-white flex justify-center items-center gap-2">
        <p className="text-[2rem] h-full flex items-center">&copy;</p>
        <p className="text-3xl h-full font-[cookie] flex items-center gap-3">
