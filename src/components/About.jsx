...
const About = () => {
  return (
    <div className="bg-gray-800 text-gray-200 min-h-screen mt-3 py-12 border-[5px] border-black ">
      <div className="max-w-3xl mx-auto px-4">
        <h1 className="text-4xl lg:text-5xl font-serif leading-tight text-center mb-8">
          <span className="text-yellow-300">W</span>elcome to Ratatouille
        </h1>
        
        <div className="text-lg lg:text-xl font-light mb-12">
