...
const Shimmer = () => {
  ...
  for (let i = 0; i < 10; i++) {
    shimmerElements.push(
      <div
        key={i}
        className="cards w-[17rem] h-[18rem] p-2.5 rounded-[20px] bg-[#ffffff] hover:scale-95 transition-all duration-200 ease-in overflow-hidden cursor-pointer flex flex-col gap-1"
      >
  ...
  return (
    <div className="p-4 grid grid-cols-5 justify-items-center mt-2 gap-10 bg-[#ffbe0b]">
      {shimmerElements}
    </div>
  );
};
